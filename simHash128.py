...
class SimHash(object):
    ...
    def getBinStr(self, source):
        ...
        md516 = md5.hexdigest()
        hashcode = bin(int(md516, 16))[2:].zfill(128)
        return hashcode
