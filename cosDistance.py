...
if __name__ == '__main__':
    ...
    dis = doc_sim("沿着荷塘，是一条曲折的小煤屑路。这是一条幽僻的路；白天也少人走，夜晚更加寂寞。荷塘四面，长着许多树，蓊蓊郁郁的。路的一旁，是些杨柳，和一些不知道名字的树。没有月光的晚上，这路上阴森森的，有些怕人。今晚却很好，虽然月光也还是淡淡的。",
            "沿着一条曲折的小煤屑路。这是一条幽僻的路；荷塘四面，长着许多树，蓊蓊郁郁的。路的一旁，是些杨柳，和一些不知道名字的树。", stop_words)
    print(dis) # 0.796
    ...
    dis = doc_sim("传统的Hash算法将文本内容随机映射为一个签名值。该签名值是完全随机的。",
            "传统的Hash算法将文本内容随机映射为一个签名值。签名值是完全随机。", stop_words)
    print(dis) # 0.999
